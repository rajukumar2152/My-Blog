...
import os    #yaha tag ko change karne ke liye message ko import kiya  hain
...
SECRET_KEY = '8+z61s%!_6vq2b@*@*ii2ams+7bi(cwd6%$g7h$y^5u7ypl!kf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['rajublog.herokuapp.com','127.0.0.1']
...
}                 #hota hain  isliye yaha tag ko change kiya hain 
